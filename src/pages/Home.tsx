...
import { useNavigate } from "react-router-dom"; // Navegação para checkout
...
export const Home: React.FC = () => {
  ...
  // Simulando plano ativo do lojista
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        {/* Conteúdos do app (stories, carrossel) */}
        ...
        {(currentPlan.id === "intermediate" || currentPlan.id === "complete") &&
          products.length > 0 && (
